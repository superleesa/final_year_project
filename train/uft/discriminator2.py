"""
Following discriminator is largely based on TOENet encoder:
@article{gao2023,
...
class TOENetDiscriminator(nn.Module):
	def __init__(self):
		super(TOENetDiscriminator,self).__init__()
...
class MainNetworkStructure(nn.Module):
	def __init__(self,inchannel,channel):
        ...
        # note: model name achronym for Encoder Large To Encoder Medium
