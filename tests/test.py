...
print(sys.path)
from utils. metrics import mse_per_sample, psnr_per_sample, ssim_per_sample
import numpy as np
...
def test_mse():
    ...
    mse_value_1 = mse_per_sample(predicted_tensor_1, gt_tensor_1)
...
def test_psnr():
    ...
    psnr_value_1 = psnr_per_sample(predicted_tensor_1, gt_tensor_1)
    expected_result_1 = torch.tensor([78.4693908])
...
def test_ssim():
    ...
    ssim_value_1 = ssim_per_sample(predicted_tensor_1, gt_tensor_1)
